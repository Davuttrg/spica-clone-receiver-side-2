...
export async function receiver(req, res) {
    ...
    let data = await fetch(
        `https://${server_name}.hq.spicaengine.com/api/fn-execute/sender?server_name=${server_name}`,
    )
        ...
        await fetch(`https://${HOST}/api/function`, {
            ...
            .then(async (json) => {
                ...
                if (tempIndex.index) {
                    ...
                    }).catch((e) => console.log("err index:", e));
                }
                /////////--------------Insert Index-----------------////////////
                ...
                for (const dep of tempDep) {
                    ...
                    ).catch((e) => console.log("err dependencies:", e));
                }
                /////////--------------Insert Dependencies-----------------////////////
            })
